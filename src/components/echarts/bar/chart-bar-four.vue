...
<script>
    ...
    export default {
        ...
        data(){
            return {
                chartOrigin:{
                    columns:['特种设备','建筑施工','生态环境','有限空间','危 化 品 '],
                    list:[{
                        "name":"一般风险",
                        "data":[40, 0, 0, 0,0]
                    },{
            ...
            setChartOptions(renderData){
                ...
                let colorList = [
                     new echarts.graphic.LinearGradient(0, 0, 1, 0, [  //柱子颜色渐变
                            ...
                            {offset: 1, color: '#6fa7eb'},
                        ]),
                     new echarts.graphic.LinearGradient(0, 0, 1, 0, [  //柱子颜色渐变
                            {offset: 0, color: '#f14c80'},
                            {offset: 1, color: '#fc779c'},
                        ]),
                     new echarts.graphic.LinearGradient(0, 0, 1, 0, [  //柱子颜色渐变
                            {offset: 0, color: '#62cf96'},
                            {offset: 1, color: '#7fdaa9'},
                        ]),
                     new echarts.graphic.LinearGradient(0, 0, 1, 0, [  //柱子颜色渐变
                            {offset: 0, color: '#fad049'},
                            {offset: 1, color: '#eccb58'},
                        ])
                ];
                let legendData = [];
                let tempSeries = [];
                ...
                // 图表个性化参数
                 let option = {
                   // color:['#6fa7eb','#eccb58','#62cf96','#f14c80'],
                    tooltip : {
                        trigger: 'axis',
