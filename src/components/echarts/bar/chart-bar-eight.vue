...
<script>
    import  chartBase from '../base/chart-base.vue'
    import  echarts from 'echarts'
    export default {
        name: "chart-bar-eight",
        data() {
            return {
                chartOrigin: {
        ...
        methods: {
            ...
            setChartOptions(renderData)  {
               ...
               // let colorList = ["#50a2f0","#66b997","#fcac53",'#afa3f5', '#00d488', '#3feed4', '#3bafff', '#f1bb4c']
                ...
                this.options = this.options?this.options:op
                ...
                if(renderData.list){
                    renderData.list.forEach(
                        (item, index) => {
                            ...
                            if(index===renderData.list.length-1){
                                tempSeries.push({
                                    name: item.name,
                                    type: 'bar',
                                    barWidth: '15px',
                                    ...
                                    markLine: {
                                        ...
                                        itemStyle: {
                                            normal: { lineStyle: { type: 'dashed', color:'#c5b168',width:1}
                                                ,label: { show: false, position:'left' } }
                                        },
                                        data: [{
                                            name: '',
                                            yAxis: _that.markLine,
                                        },
                                            [
                                                {name: '标线1起点',  x:"0%", y: 185},
                                                {name: '标线1终点', x: '0%', y: 185}
                                            ]
                                        ]
                                    },
                                    itemStyle: {
